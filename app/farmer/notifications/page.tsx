...
import { markAllMyNotificationsRead, markMyNotificationRead } from "@/lib/actions/notifications";
...
export default async function FarmerNotificationsPage({
  ...
  searchParams:
    | Promise<{ page?: string; pageSize?: string; highlight?: string }>
    | { page?: string; pageSize?: string; highlight?: string };
}) {
  ...
  if (highlightId) {
    ...
    if (target) {
      ...
      if (pageForHighlight !== page) {
        ...
        redirect(`/farmer/notifications?${q.toString()}`);
      }
    }
  }
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        ...
        {unreadCount > 0 && (
          <form action={markAllMyNotificationsRead}>
